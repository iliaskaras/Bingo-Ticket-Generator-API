...
data class BulkStripsCreationRequest(
    @field:Schema(
        description = "The number of strips to generate. Must be a positive integer and not exceed 10,000.",
        example = "1000",
        minimum = "1",
        maximum = "10000"
    )
    @field:Min(1, message = "Number of strips must be a positive integer.")
    @field:Max(10000, message = "Number of strips cannot exceed 10,000.")
